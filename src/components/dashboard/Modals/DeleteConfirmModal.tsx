          ...
          >
            <div className="p-8 text-center">
              ...
              <div className="flex gap-3">
                <button 
                  onClick={onClose}
                  className="flex-1 px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-black text-xs transition-all uppercase tracking-widest"
                >
                  Huỷ bỏ
                </button>
                <button 
                  onClick={onConfirm}
                  className="flex-1 px-4 py-3 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-black text-xs transition-all shadow-lg shadow-rose-100 uppercase tracking-widest"
                >
                  Xác nhận xoá
                </button>
              </div>
